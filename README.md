...
| `tests/` | **2,055 tests green across 116 files**, with 26 byte-for-byte golden outputs |
...
The frozen 1.0 surface is **the 51 keywords, the 85 natives** and the scene DSL.
