...
| `examples/` | **47 runnable programs**, from four lines to a playable first-person demo |
...
| `tests/` | **1,934 tests green across 109 files**, with 26 byte-for-byte golden outputs |
