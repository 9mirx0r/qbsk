// an earlier release — phoneme-based procedural naming (06-active-language-phases.md).
//
...
// A fifth stream, alongside an earlier release's four (14-...-research.md §5) — regenerating
...
// joined — the same "root + root" shape a Dwarf Fortress name has (14-...-research.md
...
writeFileSync(
  ...
  [
    ...
    "// generated by the phoneme system (14-...-research.md §2, an earlier release).",
    "// profession_roll (an earlier release) is a raw [0,1) float, resolved against a weighted",
...
writeFileSync(
  ...
  [
    "// worldgen_locations.qbdata — an earlier release (structure) + an earlier release (generated `name`,",
    ...
    "// scope (see an earlier release's scope exclusions) — positions here are still hand-placed.",
    "",
    "shape location",
    "    key: str",
    "    name: str",
